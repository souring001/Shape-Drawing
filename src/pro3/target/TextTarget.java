...
public class TextTarget implements Target{
   ...
   */
  @Override
  public void drawTriangle(int id, int x1, int y1, int x2, int y2, int x3, int y3,
      Attribute attr){
    pstream.println("shape "+id+" Triangle "+x1+" "+y1+
        " "+x2+" "+y2+" "+x3+" "+y3);
    print(attr);
  }
  ...
  public void drawPolygon(int id, int n, int xs[], int ys[], Attribute attr){
    pstream.print("shape "+id+" Polygon "+n);
    for(int i = 0; i < n; i++) pstream.print(" "+xs[i]+" "+ys[i]);
    pstream.print("\n");
    print(attr);
  }
   ...
   */
  @Override
  public void drawText(int id, String str, int x, int y, int s, 
      Attribute attr){
    pstream.println("shape "+id+" Text \""+str+"\" "+x+" "+y+
        " "+s);
    print(attr);
  }
