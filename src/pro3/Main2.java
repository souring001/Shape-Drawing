...
public class Main2{
  ...
  public static void main(String[] args){
    String data = 
      "target clear\n"+
      "shape 8 Polygon 4 278 132 361 130 364 214 240 254 Attribute 10 40 60 true\n"+
      "shape 9 Text 助けて 100 200  64 Attribute 10 40 60 true\n"+
      "shape 10 Triangle 80 400 40 90 50 60 Attribute 100 40 60 true\n"+
      "shape 11 Triangle 300 40 30 30 26 40 Attribute 100 70 30 false\n"+
      "shape 12 Triangle 80 260 20 80 260 20 Attribute 100 120 10 false\n"+
      "shape 13 Triangle 300 26 400 100 40 30 Attribute 100 140 60 true\n"+
      "shape 14 Triangle 190 150 60 80 40 40 Attribute 200 200 100 true\n"+
      "shape 16 Image 288 142 iVBORw0KGgoAAAANSUhEUgAAAAIAAAABCAYAAAD0In+KAAAAEUlEQVQImWP4v4P7/387hf8AGDsFHtYgJ0IAAAAASUVORK5CYII= &\n"+
